...
int8_t netOpt::speaker2washing(roomMember *speaker, roomMember *washing)
{
    ...
    devRecord *d2 = (devRecord *)washing->member;
        ...
        cout << dec << " with probability adjustment of " << (int)getProbAdjustment(((devRecord *)g1->mems.getHead()->data), d2, 0.0) << endl;
    #endif
    ...
    if(((devRecord *)g1->mems.getHead()->data)->activity.getLen() < 2 || d2->activity.getLen() < 2)
    {
        ...
        if(getProbAdjustment(((devRecord *)g1->mems.getHead()->data), d2, 0.0) -1 < -2)
        {
            return -2;
        }
        else if(getProbAdjustment(((devRecord *)g1->mems.getHead()->data), d2, 0.0) -1 > -1)
        {
            return 1;
        }
        else
        {
            return(getProbAdjustment(((devRecord *)g1->mems.getHead()->data), d2, 0.0) -1);
        };
    }
