...
int8_t netOpt::speaker2speaker(roomMember *m1, roomMember *m2)
{
    ...
    if(((devRecord *)g1->mems.getHead()->data)->activity.getLen() < 2 || ((devRecord *)g2->mems.getHead()->data)->activity.getLen() < 2)
    {
        ...
        if(getProbAdjustment(((devRecord *)g1->mems.getHead()->data), ((devRecord *)g2->mems.getHead()->data), 0.0) -1 < -2)
        {
            return -2;
        }
        else if(getProbAdjustment(((devRecord *)g1->mems.getHead()->data), ((devRecord *)g2->mems.getHead()->data), 0.0) -1 > -1)
        {
            return 1;
        }
        else
        {
            return(getProbAdjustment(((devRecord *)g1->mems.getHead()->data), ((devRecord *)g2->mems.getHead()->data), 0.0) -1);
        };;
    }
